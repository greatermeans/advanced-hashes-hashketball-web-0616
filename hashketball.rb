...
def num_points_scored(player)
  game_hash.each do |location,team_data|
    if game_hash[location][:players][player] != nil 
...
def player_numbers(team)
  ...
  game_hash.each do |location,team_data|
    game_hash[location][:players].each do |player,stat|
      if game_hash[location][:team_name] == team
        player_numbers << game_hash[location][:players][player][:number]
      end
    end
  end
  player_numbers
  ...
  game_hash.each do |location,team_data|
    game_hash[location][:players].each do |player,stat|
      if game_hash[location][:players][player][:shoe] > biggest_shoe
        biggest_shoe = game_hash[location][:players][player][:shoe]
        @biggest_shoe_rebounds = game_hash[location][:players][player][:rebounds]
      end
    end
  end
